        ...
        protected override void Seed(Sklep_internetowy.ProductDbContext context)
        {
            ...
            var ListOfProducts = new List<Product>()
            {
                new Product() { ProductId = 1, CategoryId = 1, BrandId = 6, GenderId = 4, Name = "Siodło Rajdowe MAX Standard",
                    ...
                    Price = 3370, GraphicFileName = "SiodloRajdoweMAXStandard.png", AddingDate = DateTime.Now, isBestseller = true, isSize = true, isColor = true, isAvaliable = true },
                ...
                new Product() { ProductId = 2, CategoryId = 2, BrandId = 5, GenderId = 4, Name = "Ochraniacze eSHOCK, PRZEDNIE",
                    ...
                    Price = 545, GraphicFileName = "EQUICK_Ochraniacze_eSHOCK_przednie.png", AddingDate = DateTime.Now, isBestseller = false, isSize = true, isColor = true, isAvaliable = true  },
                ...
                new Product() { ProductId = 3, CategoryId = 3, BrandId = 7, GenderId = 4, Name = "Kaloszki SPACE",
                    ...
                    Price = 113, GraphicFileName = "HKM_Space_Kaloszki_Rozowe.png", AddingDate = DateTime.Now, isBestseller = false, isSize = true, isColor = true, isAvaliable = true  },
                ...
                new Product() { ProductId = 4, CategoryId = 4, BrandId = 7, GenderId = 4, Name = "Owijki wełniane WOOL",
                    ...
                    Price = 279, GraphicFileName = "TORPOL_Owijki_WOOL.png", AddingDate = DateTime.Now, isBestseller = false, isSize = true, isColor = true, isAvaliable = true  },
                ...
                new Product() { ProductId = 5, CategoryId = 5, BrandId = 4, GenderId = 4, Name = "Podkładka skokowa BACK PROTECT SOLUTION",
                    ...
                    Price = 956, GraphicFileName = "WINDEREN_Podkladka_skokowa_back_protect_solution.png", AddingDate = DateTime.Now, isBestseller = true, isSize = true, isColor = true, isAvaliable = true  },
                ...
                new Product() { ProductId = 6, CategoryId = 6, BrandId = 9, GenderId = 4, Name = "Kantar EQUISITE",
                    ...
                    Price = 95, GraphicFileName = "BR_Kantar_Equisite_Zloty.png", AddingDate = DateTime.Now, isBestseller = true, isSize = true, isColor = true, isAvaliable = true  },
                ...
                new Product() { ProductId = 7, CategoryId = 7, BrandId = 7, GenderId = 4, Name = "Derka podszyta polarem",
                    ...
                    Price = 95, GraphicFileName = "Derka_podszyta_HKM_Granatowa.png", AddingDate = DateTime.Now, isBestseller = false, isSize = true, isColor = true, isAvaliable = true  },
                ...
                new Product() { ProductId = 8, CategoryId = 8, BrandId = 7, GenderId = 4, Name = "Ogłowie LOU",
                    ...
                    Price = 147, GraphicFileName = "HKM_Oglowie_LUO_Czarne.png", AddingDate = DateTime.Now, isBestseller = false, isSize = true, isColor = true, isAvaliable = true  },
                ...
                new Product() { ProductId = 9, CategoryId = 9, BrandId = 10, GenderId = 4, Name = "Popręg anatomiczny symetryczny z gumami",
                    ...
                    Price = 950, GraphicFileName = "PRESTIGE_Popreg_Czarny_Zgumami.png", AddingDate = DateTime.Now, isBestseller = false, isSize = true, isColor = true, isAvaliable = true  },
                ...
                new Product() { ProductId = 10, CategoryId = 10, BrandId = 7, GenderId = 4, Name = "Czaprak ujeżdżeniowy ANATOMIC TOP LINE",
                    ...
                    Price = 315, GraphicFileName = "Czaprak_Ujezdzeniowy_WINDEREN_TOPLine.png", AddingDate = DateTime.Now, isBestseller = false, isSize = false, isColor = true, isAvaliable = true  },
                ...
                new Product() { ProductId = 11, CategoryId = 11, BrandId = 7, GenderId = 1, Name = "Bryczesy JEANS 56 damskie",
                    ...
                    Price = 390, GraphicFileName = "Bryczesy_HKM_Kingston_Jeans56.png", AddingDate = DateTime.Now, isBestseller = false, isSize = true, isColor = true, isAvaliable = true  },
                ...
                new Product() { ProductId = 12, CategoryId = 12, BrandId = 3, GenderId = 3, Name = "Kaskotoczek z regulacją czarny",
                    ...
                    Price = 109, GraphicFileName = "Kaskotoczek_York_Regulacja_Czarny.png", AddingDate = DateTime.Now, isBestseller = true, isSize = true, isColor = true, isAvaliable = true  },
                ...
                new Product() { ProductId = 13, CategoryId = 13, BrandId = 7, GenderId = 3, Name = "Podkolanówki WINDSOR",
                    ...
                    Price = 39, GraphicFileName = "HKM_Podkolanowki_Windsor.png", AddingDate = DateTime.Now, isBestseller = false, isSize = true, isColor = true, isAvaliable = true  }
